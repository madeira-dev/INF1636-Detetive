...
class Cell {
	...
	/*
	 * Usado para debugging. Printa no terminal o que essa casa contém. NÃO É
	 * PERMANENTE, SERÁ SUBSTITUÍDO PELA INTERFACE GRÁFICA ESCOLHIDA
	 */
	public void print() {
		if (fora_do_mapa) {
			System.out.print("X ");
	...
	public void coloca_no_mapa() {
		this.fora_do_mapa = false;
	}

	public void aloca_personagem(String personagem) {
