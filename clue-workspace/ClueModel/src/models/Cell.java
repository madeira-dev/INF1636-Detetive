...
class Cell{
    ...
    public void tira_do_mapa() { this.fora_do_mapa = true; }
    
    public void vira_comodo(String comodo) { this.room = comodo; }
    ...
    public void configura_passagem(Cell cell) { shortcut = cell; }
    ...
    public Cell get_passagem() { return shortcut; }
    
    public boolean is_room() { return !Objects.equals(this.room, ""); }
    
    public boolean has_shortcut() { return this.shortcut != null; }
    
    // Checa se o espaço é válida
    public boolean is_free() { return !fora_do_mapa && Objects.equals(personagem, ""); }
