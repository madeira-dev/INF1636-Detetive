...
public class MoveNode {
    ...
    public boolean is_final() { return this.is_final; }
    
    public int get_x(){ return cell.get_x(); }
    
    public int get_y(){ return cell.get_y(); }
    
    public Cell get_shortcut() { return cell.get_passagem(); }
    
    public String get_room() { return cell.getRoom(); }
    ...
    public boolean has_shortcut(){ return cell.has_shortcut(); }
    public boolean is_room(){ return cell.is_room(); }
    }
